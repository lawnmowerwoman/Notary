...
Der Notary-Status in der macOS-Menüleiste bleibt leise. Ein Notar ist präsent, aber nicht laut.

- das dauerhafte StatusItem nutzt ein ruhiges, systemkonformes Shield
- keine schreienden Farben, keine Panikästhetik und keine aggressive Badge-Sprache im geschlossenen Zustand
- Statusfarben erscheinen erst nach dem Klick, wenn Notary bewusst "spricht"
- die geöffnete Statusfläche darf dann klar zwischen `OK`, `Achtung` und `Fail` unterscheiden
- kurze Handlungssprache schlägt Alarmrhetorik: Status erklären, nächste Schritte anbieten, nicht dramatisieren
...
- [Notary-App-Icon-Concept.svg](Notary-App-Icon-Concept.svg)
