...
package struct ManagedConfig {
    ...
    package var telemetry: ManagedTelemetryConfig
    ...
    package static func from(rawSnapshot: [String: Any], logger: HardenLogger) -> ManagedConfig {
        ...
        var cfg = ManagedConfig(
            ...
            telemetry: ManagedTelemetryConfig(
                wirelessReporting: TelemetryWirelessReportingMode.betaValue(
                    from: telemetry["ReportConnectedWireless"]
                )
            )
        )
...
package struct ManagedTelemetryConfig {
    package var wirelessReporting: TelemetryWirelessReportingMode
}
